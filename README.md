...
* [VerifyWise](https://github.com/verifywise-ai/verifywise) ⭐ 352 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-17 - Complete AI governance and LLM evals platform with support for EU AI Act, ISO 42001, NIST AI RMF, and 20+ frameworks (\~247 stars).
* [Compl-AI](https://github.com/compl-ai/compl-ai) ⭐ 209 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - Compliance-centered LLM evaluation framework with technical interpretation of the AI Act and benchmarking suite covering six core principles.
...
* [AI Act Implementation Tool (Algorithm Audit)](https://github.com/NGO-Algorithm-Audit/AI-Act-Implementation-Tool) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-17 - Risk classification of algorithmic systems using simplified questionnaires.
...
* [Hugging Face EU AI Act Guide for OSS Developers](https://github.com/huggingface/blog/blob/main/eu-ai-act-for-oss-developers.md) ⭐ 3,524 | 🐛 249 | 🌐 Jupyter Notebook | 📅 2026-09-17 - Official guide covering obligations for GPAI models, copyright compliance, and documentation requirements.
...
* [Bifrost](https://github.com/maximhq/bifrost) ⭐ 8,147 | 🐛 1,059 | 🌐 Go | 📅 2026-09-18 - Open-source Go gateway for LLM and MCP traffic with routing, request logging, and usage controls.
* [Microsoft Agent Governance Toolkit](https://github.com/microsoft/agent-governance-toolkit) ⭐ 6,281 | 🐛 160 | 🌐 Python | 📅 2026-09-17 - Seven-package, MIT-licensed runtime governance system for autonomous AI agents covering all 10/10 OWASP Agentic Top 10 (2026) with EU AI Act, NIST AI RMF, HIPAA, and SOC 2 mappings. Enforces policy at <0.1ms p99 latency across LangChain, CrewAI, AutoGen, OpenAI Agents, Google ADK, and 8+ agent frameworks. Python, TypeScript, .NET, Rust, and Go (\~900+ stars).
...
* [Vaara](https://github.com/vaaraio/vaara) ⭐ 12 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Python runtime evidence layer for AI agents: policy-gated tool calls, hash-chained tamper-evident audit trails with external time anchoring, and independently verifiable execution receipts, aligned with EU AI Act Article 14 (human oversight) and Article 12 (record-keeping). AGPL-3.0-or-later.
...
* [AGT EU AI Act Compliance Checklist](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/eu-ai-act-checklist.md) ⭐ 6,281 | 🐛 160 | 🌐 Python | 📅 2026-09-17 - Maps Agent Governance Toolkit controls to EU AI Act requirements.
* [AGT NIST AI RMF Alignment](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/nist-ai-rmf-alignment.md) ⭐ 6,281 | 🐛 160 | 🌐 Python | 📅 2026-09-17 - Maps Agent Governance Toolkit controls to the NIST AI Risk Management Framework.
* [AGT SOC 2 Type II Mapping](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/soc2-mapping.md) ⭐ 6,281 | 🐛 160 | 🌐 Python | 📅 2026-09-17 - Self-assessment mapping Agent Governance Toolkit controls to SOC 2 criteria.
* [AGT Known Limitations](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/LIMITATIONS.md) ⭐ 6,281 | 🐛 160 | 🌐 Python | 📅 2026-09-17 - Documents Agent Governance Toolkit design boundaries and compliance gaps.

### Curated Lists

* [Awesome AI Regulation](https://github.com/EthicalML/awesome-artificial-intelligence-regulation) ⭐ 1,465 | 🐛 4 | 📅 2026-09-14 - Broader AI regulation ecosystem mapping including guidelines, principles, and standards (\~800 stars).
* [Awesome Responsible AI](https://github.com/AthenaCore/AwesomeResponsibleAI) ⭐ 147 | 🐛 31 | 📅 2026-09-02 - Curated list of responsible, trustworthy, and human-centered AI resources.
...
* [SHAP](https://github.com/shap/shap) ⭐ 25,760 | 🐛 989 | 🌐 Jupyter Notebook | 📅 2026-09-16 - Game-theoretic ML explainability using Shapley values; the most widely used explainability library (\~23,000 stars).
...
* [Captum (Meta/PyTorch)](https://github.com/meta-pytorch/captum) ⭐ 5,702 | 🐛 75 | 🌐 Python | 📅 2026-09-13 - Model interpretability with Integrated Gradients, SHAP, LIME, and saliency maps for PyTorch.
...
* [AI Fairness 360 (IBM/Linux Foundation)](https://github.com/Trusted-AI/AIF360) ⭐ 2,866 | 🐛 223 | 🌐 Python | 📅 2026-06-15 - 70+ fairness metrics and 10+ bias mitigation algorithms (\~2,500 stars).
* [Fairlearn (Microsoft)](https://github.com/fairlearn/fairlearn) ⭐ 2,286 | 🐛 124 | 🌐 Python | 📅 2026-09-15 - Assessing and improving fairness with group fairness metrics and mitigation algorithms (\~1,900 stars).
...
* [Adversarial Robustness Toolbox (IBM/Linux Foundation)](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,234 | 🐛 28 | 🌐 Python | 📅 2025-12-12 - Comprehensive framework for evaluating ML security with attacks, defenses, and metrics.
...
* [PySyft (OpenMined)](https://github.com/OpenMined/PySyft) ⭐ 10,031 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - Secure and private deep learning supporting federated learning and secure computation.
...
* [OpenDP](https://github.com/opendp/opendp) ⭐ 435 | 🐛 350 | 🌐 Rust | 📅 2026-09-16 - Library for privacy-aware computations with differential privacy.
...
Please [open an issue](https://github.com/GenAI-Gurus/awesome-eu-ai-act/issues) ⭐ 105 | 🐛 12 | 📅 2026-09-17 if you find a broken link or know a resource that belongs here.
