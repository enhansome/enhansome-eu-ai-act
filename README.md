...
* [VerifyWise](https://github.com/verifywise-ai/verifywise) ⭐ 356 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-22 - Complete AI governance and LLM evals platform with support for EU AI Act, ISO 42001, NIST AI RMF, and 20+ frameworks (\~247 stars).
...
* [Hugging Face EU AI Act Guide for OSS Developers](https://github.com/huggingface/blog/blob/main/eu-ai-act-for-oss-developers.md) ⭐ 3,530 | 🐛 248 | 🌐 Jupyter Notebook | 📅 2026-09-22 - Official guide covering obligations for GPAI models, copyright compliance, and documentation requirements.
...
* [Bifrost](https://github.com/maximhq/bifrost) ⭐ 8,247 | 🐛 1,126 | 🌐 Go | 📅 2026-09-22 - Open-source Go gateway for LLM and MCP traffic with routing, request logging, and usage controls.
* [Microsoft Agent Governance Toolkit](https://github.com/microsoft/agent-governance-toolkit) ⭐ 6,317 | 🐛 122 | 🌐 Python | 📅 2026-09-23 - Seven-package, MIT-licensed runtime governance system for autonomous AI agents covering all 10/10 OWASP Agentic Top 10 (2026) with EU AI Act, NIST AI RMF, HIPAA, and SOC 2 mappings. Enforces policy at <0.1ms p99 latency across LangChain, CrewAI, AutoGen, OpenAI Agents, Google ADK, and 8+ agent frameworks. Python, TypeScript, .NET, Rust, and Go (\~900+ stars).
...
* [agent-security-harness](https://github.com/msaleme/red-team-blue-team-agent-fabric) ⭐ 29 | 🐛 21 | 🌐 Python | 📅 2026-09-22 - Adversarial testing framework for autonomous agents with EU AI Act crosswalks.
* [Vaara](https://github.com/vaaraio/vaara) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Python runtime evidence layer for AI agents: policy-gated tool calls, hash-chained tamper-evident audit trails with external time anchoring, and independently verifiable execution receipts, aligned with EU AI Act Article 14 (human oversight) and Article 12 (record-keeping). AGPL-3.0-or-later.
...
* [AGT EU AI Act Compliance Checklist](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/eu-ai-act-checklist.md) ⭐ 6,317 | 🐛 122 | 🌐 Python | 📅 2026-09-23 - Maps Agent Governance Toolkit controls to EU AI Act requirements.
* [AGT NIST AI RMF Alignment](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/nist-ai-rmf-alignment.md) ⭐ 6,317 | 🐛 122 | 🌐 Python | 📅 2026-09-23 - Maps Agent Governance Toolkit controls to the NIST AI Risk Management Framework.
* [AGT SOC 2 Type II Mapping](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/compliance/soc2-mapping.md) ⭐ 6,317 | 🐛 122 | 🌐 Python | 📅 2026-09-23 - Self-assessment mapping Agent Governance Toolkit controls to SOC 2 criteria.
* [AGT Known Limitations](https://github.com/microsoft/agent-governance-toolkit/blob/main/docs/LIMITATIONS.md) ⭐ 6,317 | 🐛 122 | 🌐 Python | 📅 2026-09-23 - Documents Agent Governance Toolkit design boundaries and compliance gaps.

### Curated Lists

* [Awesome AI Regulation](https://github.com/EthicalML/awesome-artificial-intelligence-regulation) ⭐ 1,467 | 🐛 5 | 📅 2026-09-22 - Broader AI regulation ecosystem mapping including guidelines, principles, and standards (\~800 stars).
* [Awesome Responsible AI](https://github.com/AthenaCore/AwesomeResponsibleAI) ⭐ 150 | 🐛 32 | 📅 2026-09-22 - Curated list of responsible, trustworthy, and human-centered AI resources.
...
* [SHAP](https://github.com/shap/shap) ⭐ 25,773 | 🐛 984 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Game-theoretic ML explainability using Shapley values; the most widely used explainability library (\~23,000 stars).
...
* [InterpretML (Microsoft)](https://github.com/interpretml/interpret) ⭐ 6,946 | 🐛 42 | 🌐 C++ | 📅 2026-09-21 - Trains interpretable glassbox models (EBM) and explains blackbox systems (\~6,000 stars).
...
* [Responsible AI Toolbox (Microsoft)](https://github.com/microsoft/responsible-ai-toolbox) ⭐ 1,836 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-10 - Unified dashboard combining Fairlearn, InterpretML, Error Analysis, and Counterfactual Analysis (\~1,300 stars).
...
* [PySyft (OpenMined)](https://github.com/OpenMined/PySyft) ⭐ 10,033 | 🐛 17 | 🌐 Python | 📅 2026-09-23 - Secure and private deep learning supporting federated learning and secure computation.
...
* [OpenDP](https://github.com/opendp/opendp) ⭐ 435 | 🐛 356 | 🌐 Rust | 📅 2026-09-22 - Library for privacy-aware computations with differential privacy.
